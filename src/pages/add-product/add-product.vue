<template>
      <div class="body">
        ...
        <popup
          v-if="show_popup"
          popup_message="Product added Succesfully"
          _link='..'
        />
        <a 
          href=".." 
...
export default {
  ...
  methods: {
    ...
    add_item() {
      ...
      (this_object = this).show_popup = true
      let hidden_link = this.$refs.hidden_link;
      setTimeout(function() {
        this_object.show_popup = false;
        hidden_link.click();
      }, 3000);
    },
    imChanged(event) {
